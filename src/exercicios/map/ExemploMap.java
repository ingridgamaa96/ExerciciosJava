...
/* Dados os modelos dos carros e seus respectivos consumos
na estrada, faça:
...
public class ExemploMap {
    public static void main(String[] args) {
        ...
        não dá pra exibir por índice usando Map */
        ...
        Iterator<Double> iterator = carrosPopulares.values().iterator();//pode usar iterator pq o resultado é uma collection
        Double soma = 0d;
        ...
        Iterator<Double> iterator1 = carrosPopulares.values().iterator();//pode usar iterator pq o resultado é uma collection
